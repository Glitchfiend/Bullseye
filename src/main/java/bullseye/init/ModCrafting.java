...
public class ModCrafting
{
    ...
    private static void addCraftingRecipies()
    {
    	...
    	GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(BEItems.arrow, 4, ItemBEArrow.ArrowType.DIAMOND_ARROW.ordinal()), new Object [] {"D", "S", "F", 'D', Items.diamond, 'S', "stickWood", 'F', Items.feather}));
    	...
    	GameRegistry.addShapedRecipe(new ItemStack(BEItems.arrow_topper, 1, ItemArrowTopper.TopperType.ICE_ARROW_TOPPER.ordinal()), new Object [] {" S ", "SPS", " S ", 'S', Items.snowball, 'P', Items.prismarine_crystals});
    	GameRegistry.addShapedRecipe(new ItemStack(BEItems.arrow_topper, 1, ItemArrowTopper.TopperType.LIGHTNING_ARROW_TOPPER.ordinal()), new Object [] {" Q ", "QNQ", " Q ", 'Q', Items.quartz, 'N', Items.nether_star});
    }
}
