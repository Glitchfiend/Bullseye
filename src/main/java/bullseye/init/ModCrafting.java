...
public class ModCrafting
{
    ...
    private static void addCraftingRecipies()
    {
    	...
    	// Arrow Toppers
    	GameRegistry.addShapedRecipe(new ItemStack(BEItems.arrow_topper, 2, ItemArrowTopper.TopperType.FIRE_ARROW_TOPPER.ordinal()), new Object [] {" B ", "BCB", " B ", 'B', Items.blaze_powder, 'C', Items.coal});
    	GameRegistry.addShapedRecipe(new ItemStack(BEItems.arrow_topper, 2, ItemArrowTopper.TopperType.ICE_ARROW_TOPPER.ordinal()), new Object [] {" F ", "FIF", " F ", 'F', Items.snowball, 'I', Blocks.ice});
    	GameRegistry.addShapedRecipe(new ItemStack(BEItems.arrow_topper, 2, ItemArrowTopper.TopperType.LIGHTNING_ARROW_TOPPER.ordinal()), new Object [] {" P ", "PNP", " P ", 'P', Items.prismarine_crystals, 'N', Items.nether_star});
    	GameRegistry.addShapedRecipe(new ItemStack(BEItems.arrow_topper, 2, ItemArrowTopper.TopperType.BOMB_ARROW_TOPPER.ordinal()), new Object [] {" C ", "CGC", " C ", 'C', Items.clay_ball, 'G', Items.gunpowder});
    }
}
